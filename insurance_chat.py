...
def word2tag_insurance(keyword):
  ...
  for word in keyword:
    ...
    for intent in insurance_data['intents']:
      # print(intent['tag'])
...
def insurance_final_process(sentence):
  ...
  keyword_tag = word2tag_insurance(keyword)
...
def main_insurance():
  while True:
    ...
    if sentence == 'q':
      ...
      keyword_tag = insurance_final_process(sentence)
