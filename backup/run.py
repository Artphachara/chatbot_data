...
def classtify_word(sentence):
    sentence = word_tokenize(sentence, custom_dict=add_dict.trie, keep_whitespace=False, engine='newmm')
...
def main():
  while True:
    ...
    if sentence == 'q':
      ...
      ### if word not in keyword_tag มีปัญหา รอแก้
